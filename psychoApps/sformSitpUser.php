...
$tgl_mulai_pkl = isset($_POST['tgl_mulai_pkl']) ? mysqli_real_escape_string($con, $_POST['tgl_mulai_pkl']) : '2026-06-22';
$tgl_selesai_pkl = isset($_POST['tgl_selesai_pkl']) ? mysqli_real_escape_string($con, $_POST['tgl_selesai_pkl']) : '2026-08-14';
...
if ($file_error !== UPLOAD_ERR_OK) {
    ...
    switch ($file_error) {
        case 1:
            $error_msg .= "Ukuran file melampaui 'upload_max_filesize' di php.ini server.";
            break;
        case 2:
            $error_msg .= "Ukuran file melampaui batas MAX_FILE_SIZE yang ditentukan di form HTML.";
            break;
        case 3:
            $error_msg .= "File hanya terupload sebagian.";
            break;
        case 4:
            $error_msg .= "Tidak ada file yang dipilih untuk diupload.";
            break;
        case 6:
            $error_msg .= "Folder penyimpanan sementara (tmp) tidak ditemukan di server.";
            break;
        case 7:
        ...
        case 8:
            ...
            break;
        default:
            $error_msg .= "Terjadi error yang tidak diketahui.";
            break;
    }
    die($error_msg);
}
