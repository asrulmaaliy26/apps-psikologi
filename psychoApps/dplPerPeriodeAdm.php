                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td width="4%" class="pr-1"> <?php echo "<a class='btn btn-outline-danger btn-flat btn-xs btn-block' href='deleteDplAdm.php?id=".$data['id_dpl']."&id_pkl=".$id."&page=".$page."' onclick='return confirm(\"Yakin hapus DPL ini? Data peserta & nilai tetap aman, hanya penugasan DPL yang dihapus.\")' title='Hapus DPL'><i class='far fa-trash-alt'></i></a>";?> </td>
                          </tr>
