...
if ($id == 'dummy') {
   // DATA DUMMY UNTUK PREVIEW LAYOUT MAGANG KELOMPOK
   $dt = [
      'id' => 'dummy',
      'no_agenda_surat' => '104',
      'tgl_dikeluarkan' => date('Y-m-d'),
      'lembaga_tujuan_surat' => 'PT. Pelabuhan Indonesia (Persero)',
      'alamat_lengkap_lts' => 'Jl. Perak Timur No. 610, Surabaya',
      'kota_lts' => '1', // Dummy ID Kota
      'sebutan_pimpinan' => '1', // Dummy ID Sebutan
      'nama_obyek' => 'Divisi Sumber Daya Manusia',
   ...
   // Array dummy anggota kelompok magang
   $dummy_anggota = [
