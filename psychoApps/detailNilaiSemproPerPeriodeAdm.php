                      ...
                      <table class="table table-hover m-0 table-bordered text-center table-sm small custom">
                        ...
                        <tbody>
                          <?php
                            ...
                            $penguji1 = $dt_jdwl['penguji1'] ?? '';
                            $qry_p1 = "SELECT * FROM dt_pegawai WHERE id='$penguji1'";
                            ...
                            $penguji2 = $dt_jdwl['penguji2'] ?? '';
                            $qry_p2 = "SELECT * FROM dt_pegawai WHERE id='$penguji2'";
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center"> <span data-toggle="tooltip" data-placement="top" title="<?php echo $dt_p1['nama'];?>"><?php include("nilaiNarsum1PesSemproUser.php");?></span> </td>
                            <td class="text-center"> <span data-toggle="tooltip" data-placement="top" title="<?php echo $dt_p2['nama'];?>"><?php include("nilaiNarsum2PesSemproUser.php");?></span> </td>
