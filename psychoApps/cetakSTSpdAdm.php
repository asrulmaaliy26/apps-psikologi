...
<head>
   ...
   <style>
      ...
      table.table-lampiran td,
      table.table-lampiran th {
         border: 1px solid black;
         padding: 3px;
         text-align: justify;
      }
      ...
      table.table-kepada td,
      table.table-kepada th {
         border: 1px solid black;
         padding: 2px;
         text-align: justify;
      }
      ...
      .ttd {
         ...
         /* text-align: center; */
         line-height: 80px;
         /* membuat * berada di tengah vertikal */
      }
...
<body style="font-family:Arial, Helvetica, sans-serif; font-size:15px;">
   ...
   <table width="100%">
      ...
      <tr valign="top" align="justify">
         ...
         <td>
            ...
            if ($jumPersonil == 1) {
               ...
               if ($dambilpersonil['nama'] == $dtpersonil['id']) {
               ...
               <ol type="a">
                  ...
                  while ($dambilpersonil = mysqli_fetch_assoc($resambilpersonil)) {
                     ...
                     $dtpersonil = mysqli_fetch_assoc($respersonil);
                  ?>
                     <li><?php if ($dambilpersonil['nama'] == $dtpersonil['id']) {
                              echo $dtpersonil['nama'];
                           } else {
                              echo $dambilpersonil['nama'];
                           } ?></li>
      ...
      <tr valign="top" align="justify">
         ...
         <td>
            ...
            if ($jumPersonil == 1) {
               ...
               if ($dambilpersonil['jabatan_st'] == $dtjab['id']) {
                  echo $dtjab['nm'] . ' ' . $data1['nm'];
               }
               if ($dambilpersonil['jabatan_st'] != $dtjab['id']) {
               ...
               <ol type="a">
                  ...
                  while ($dambilpersonil = mysqli_fetch_assoc($resambilpersonil)) {
                     ...
                     $dtjab = mysqli_fetch_assoc($resjab);
                  ?>
                     <li><?php if ($dambilpersonil['jabatan_st'] == $dtjab['id']) {
                              echo $dtjab['nm'] . ' ' . $data1['nm'];
                           } else {
                              echo $dambilpersonil['jabatan_st'];
                           } ?></li>
      ...
      <?php if (empty($dataku['dasar'])) {
         include "nonDasarStSpd.php";
      } else {
         include "dasarStSpd.php";
      } ?>
   </table>
   <br />
   <br />
