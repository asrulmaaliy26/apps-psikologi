...
<body style="font-family:Arial, Helvetica, sans-serif; font-size:16px;">
   ...
   <p style="text-align:center;"><strong>
         <font style="font-size:18px; text-decoration:underline;">SURAT KETERANGAN KELAKUAN BAIK</font>
      </strong><br />
      <font style="font-size:16px;">Nomor:<?php if ($dt['no_agenda_surat'] == '') {
                                             echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
                                          } else {
                                             echo '&nbsp;' . $dt['no_agenda_surat'];
                                          } ?>/<?php echo $dkddekanat3['kd_nmr_srt']; ?>/PP.009/<?php echo "$ambilbln"; ?>/<?php echo "$ambilthn"; ?></font>
   </p>
