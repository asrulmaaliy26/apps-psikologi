...
if ($id == 'dummy') {
   // DATA DUMMY UNTUK PREVIEW LAYOUT PRA-SKRIPSI
   $dt = [
      'id' => 'dummy',
      'no_agenda_surat' => '103',
      'tgl_dikeluarkan' => date('Y-m-d'),
      'lembaga_tujuan_surat' => 'Panti Asuhan Kasih Bunda',
      'alamat_lengkap_lts' => 'Jl. Veteran No. 10, Malang',
      'kota_observasi' => '1',
      'sebutan_pimpinan' => '1',
      'judul_prop' => 'Analisis Kesejahteraan Psikologis Anak di Panti Asuhan',
      'nama_obyek' => 'Anak-anak Panti Asuhan Kasih Bunda',
      'tgl_awal_pelaksanaan' => date('Y-m-d', strtotime('+3 days')),
      'tgl_akhir_pelaksanaan' => date('Y-m-d', strtotime('+10 days')),
   ...
   $ddp1 = ['nama' => 'Dr. H. M. Lutfi Mustafa, M.Ag'];
   $ddp2 = ['nama' => 'Zainal Habib, M.Hum'];
   $nm_kota = 'Malang';
   $nm_lembaga = 'Fakultas Psikologi';
   $nm_lembaga_induk = 'Universitas Contoh';
   $dsp = ['nm' => 'Ketua Yayasan'];
   $dmodelpelaksanaan = ['nm' => 'Wawancara Mendalam'];
   $ambilbln = date('n');
   $ambilthn = date('Y');
   ...
   $dmodelpelaksanaan = mysqli_fetch_assoc($resmodelpelaksanaan) ?: ['nm' => 'Kegiatan'];
         ...
         <td colspan="2" style="text-align:justify;">
            ...
            <table width="100%" style="padding-left:0px;">
               ...
               <tr valign="top">
                  ...
                  <td align="center">:</td>
                  <td><?php if (empty($dt['dosen_pembimbing2'])) {
                           echo $ddp1['nama'];
                        } else {
                           echo "<ol style='margin-top: 0 !important; padding-left: 1em;'><li>$ddp1[nama]</li><li>$ddp2[nama]</li></ol>";
                        } ?></td>
               </tr>
               <tr valign="top">
