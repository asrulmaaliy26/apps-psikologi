                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1" width="4%"> 
                              <?php 
                              if(($data1['nip'] ?? null)==$id || ($data2['dosen_wali'] ?? null)==$id || ($data3['penguji1'] ?? null)==$id || ($data4['penguji2'] ?? null)==$id || ($data5['ketua_penguji'] ?? null)==$id || ($data6['sekretaris_penguji'] ?? null)==$id || ($data7['penguji_utama'] ?? null)==$id || ($data8['nip'] ?? null)==$id || ($data9['nip'] ?? null)==$id || ($data10['penguji1'] ?? null)==$id || ($data11['penguji2'] ?? null)==$id || ($data12['penguji3'] ?? null)==$id || ($data13['penguji4'] ?? null)==$id || ($data14['penguji1'] ?? null)==$id || ($data15['penguji2'] ?? null)==$id || ($data16['penguji3'] ?? null)==$id || ($data17['penguji4'] ?? null)==$id || ($data18['nip_dospem_tesis1'] ?? null)==$id || ($data19['nip_dospem_tesis2'] ?? null)==$id || ($data20['dospem_tesis1'] ?? null)==$id || ($data21['dospem_tesis2'] ?? null)==$id || ($data22['dospem_tesis1'] ?? null)==$id || ($data23['dospem_tesis2'] ?? null)==$id || ($data24['dosen_pembimbing'] ?? null)==$id || ($data25['penerima'] ?? null)==$id || ($data26['dospem_skripsi1'] ?? null)==$id || ($data27['dospem_skripsi2'] ?? null)==$id || ($data28['nama'] ?? null)==$id || ($data29['nama'] ?? null)==$id || ($data30['pembimbing1'] ?? null)==$id || ($data31['pembimbing2'] ?? null)==$id || ($data32['pembimbing1'] ?? null)==$id || ($data33['pembimbing2'] ?? null)==$id || ($data34['dosen_pembimbing1'] ?? null)==$id || ($data35['dosen_pembimbing2'] ?? null)==$id || ($data36['dosen_pembimbing'] ?? null)==$id || ($data37['dosen_pembimbing1'] ?? null)==$id || ($data38['dosen_pembimbing1'] ?? null)==$id || ($data39['dekan'] ?? null)==$id || ($data40['penerima'] ?? null)==$id || ($data41['ppk'] ?? null)==$id || ($data42['dekan'] ?? null)==$id || ($data43['dekan'] ?? null)==$id || ($data44['wd1'] ?? null)==$id || ($data45['wd1'] ?? null)==$id || ($data46['wd1'] ?? null)==$id || ($data47['wd1'] ?? null)==$id || ($data48['wd1'] ?? null)==$id || ($data49['wd1'] ?? null)==$id || ($data50['wd1'] ?? null)==$id || ($data51['wd1'] ?? null)==$id || ($data52['wd1'] ?? null)==$id || ($data53['wd1'] ?? null)==$id || ($data54['kp2'] ?? null)==$id || ($data55['wd1'] ?? null)==$id || ($data56['kp2'] ?? null)==$id || ($data57['username'] ?? null)==$id)
