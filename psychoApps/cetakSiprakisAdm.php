...
if ($id == 'dummy') {
    // DATA DUMMY UNTUK PREVIEW LAYOUT PRAKTIKUM SISWA
    $dt = [
        'id' => 'dummy',
        'no_agenda_surat' => '106',
        ...
        'jenjang_testee' => '1',
        'sebutan_pimpinan' => '1',
        'lembaga_tujuan_surat' => 'SMA Negeri 1 Malang',
        'tujuan_prak' => 'SMA Negeri 1 Malang',
        'alamat_lengkap_lts' => 'Jl. Tugu No. 1, Malang',
        'nama_testee' => 'Siswa Kelas XI IPA',
        'waktu' => date('Y-m-d', strtotime('+1 week')),
        'jam' => '08.00',
    ...
    $nm_kota = 'Malang';
    $dsp = ['nm' => 'Bapak/Ibu'];
    $dmk = ['nama' => 'Psikodiagnostik'];
    $djt = ['nama' => 'Siswa/Siswi'];
    $dtp = ['nm' => 'Aula MIN 1 Malang'];
    $ambilbln = date('n');
    $ambilthn = date('Y');
