<?php include( "contentsConAdm.php" );
  // Auto-close: nonaktifkan periode yang end_datetime sudah terlewat
  mysqli_query($con, "UPDATE pendaftaran_kompre SET status='2' WHERE status='1' AND end_datetime < NOW()");
