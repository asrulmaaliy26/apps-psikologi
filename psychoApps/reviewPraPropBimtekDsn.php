    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h6 class="m-0">Review Pra Proposal</h6>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                  <table class="table table-sm table-borderless mb-3">
                    <tr>
                      ...
                      <td>: <?php echo $d_prop['nama_bimtek']; ?></td>
                    </tr>
                    <tr>
                      <th>NIM</th>
                      <td>: <?php echo $d_prop['nim']; ?></td>
                    </tr>
                    <tr>
                      <th>Nama Mahasiswa</th>
                      <td>: <strong><?php echo $d_prop['mhs_nama']; ?></strong></td>
                    </tr>
                    <tr>
                      <th>Peminatan</th>
                      <td>: <?php echo $d_prop['nm_pem']; ?></td>
                    </tr>
                    <tr>
                      <th>Tgl Submit</th>
                    ...
                    <tr>
                      <th>Tgl Update</th>
                      <td>: <?php echo $d_prop['tgl_update']; ?></td>
                    </tr>
                  </table>
