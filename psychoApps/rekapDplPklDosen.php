<?php include( "contentsConAdm.php" );
  ...
  $id_dpl = $_SESSION['username']; // nip dosen yang login
  ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h6 class="m-0">Peserta PKL (Sebagai DPL)</h6>
            </div>
            <div class="col-sm-6">
            ...
            <section class="col-md-12 connectedSortable">
              <div class="card card-outline card-info">
                <div class="card-header">
                  <div class="clearfix">
                    <h4 class="card-title float-left">Daftar Mahasiswa DPL PKL</h4>
                  </div>
                </div>
                      ...
                      <tbody>
                        <?php
                          ...
                          $sql = "SELECT p.*, m.nama as nama_mhs 
                                  ...
                                  WHERE p.val_adm='2' AND p.dpl='$id_dpl' ORDER BY p.id DESC";
                        ...
                        <tr>
                          ...
                          <td class="text-center"> 
                            <a href="formNilaiDplPklAdm.php?id_peserta=<?php echo $data['id'];?>&source=dosen" class="btn btn-outline-primary btn-xs"><i class="fas fa-edit"></i> Input Nilai DPL & Supervisor</a>
                          </td>
                        </tr>
                        <?php
                          }
