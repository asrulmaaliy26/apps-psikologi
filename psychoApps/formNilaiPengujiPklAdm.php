  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h6 class="m-0">Penilaian PKL (Penguji)</h6>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item small"><a class="text-info" href="rekapPengujiPklDosen.php">Kembali ke Daftar Peserta</a></li>
                <li class="breadcrumb-item active small">Input Nilai Penguji</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <section class="col-md-12 connectedSortable">
              <div class="card card-outline card-info">
                ...
                <div class="card-body pt-2 pb-2 pl-3 pr-3">
                  <form name="update" method="post" action="updateNilaiPengujiPklAdm.php" onSubmit="return confirm('Simpan nilai?')">
                    ...
                    <div class="row">
                      <div class="col-md-9">
                        <ul class="nav nav-tabs nav-fill mb-0" id="nilaiTab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active font-weight-bold" id="tab-peng-lap-tab" data-toggle="tab" href="#tab-peng-lap" role="tab">
                              <i class="fas fa-file-alt mr-1"></i> Penilaian Laporan
                              <br><small class="text-muted font-weight-normal">10%</small>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link font-weight-bold" id="tab-peng-pres-tab" data-toggle="tab" href="#tab-peng-pres" role="tab">
                              <i class="fas fa-chalkboard mr-1"></i> Penilaian Presentasi
                              <br><small class="text-muted font-weight-normal">10%</small>
                            </a>
                          </li>
                        </ul>
                        ...
                        <div class="tab-content border border-top-0 rounded-bottom" id="nilaiTabContent">
                          ...
                          <!-- Tab 1: Penilaian Laporan -->
                          <div class="tab-pane fade show active p-3" id="tab-peng-lap" role="tabpanel">
                              ...
                              <table class="table table-striped table-hover table-sm m-0">
                                ...
                                <tbody>
                                    ...
                                    for($i=1; $i<=6; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">'.$peng_lap_labels[$i-1].'</td>
                                ...
                                <tfoot class="bg-light">
                                  <tr>
                                    ...
                                    <td class="text-center font-weight-bold text-success" id="avg_peng_lap">0.00</td>
                                  </tr>
                                </tfoot>
                              </table>
                            </div>
                          ...
                          <!-- Tab 2: Penilaian Presentasi -->
                          <div class="tab-pane fade p-3" id="tab-peng-pres" role="tabpanel">
                            <div class="table-responsive">
                              <table class="table table-striped table-hover table-sm m-0">
                                <thead class="bg-info text-white">
                                  <tr>
                                ...
                                <tbody>
                                    ...
                                    for($i=1; $i<=6; $i++) {
                                        ...
                                        <tr>
                                            <td class="text-center align-middle font-weight-bold">'.$i.'.</td>
                                            <td class="align-middle">'.$peng_pres_labels[$i-1].'</td>
                                            <td class="text-center">
                                                <input type="number" min="0" max="100" step="0.01" class="form-control form-control-sm text-center font-weight-bold text-primary" name="'.$f.'" value="'.($nilai ? $nilai[$f] : '').'" placeholder="0 - 100" required>
                                            </td>
                                        </tr>
                                ...
                                <tfoot class="bg-light">
                                  <tr>
                                    <td colspan="2" class="text-right font-weight-bold">Rata-Rata:</td>
                                    <td class="text-center font-weight-bold text-success" id="avg_peng_pres">0.00</td>
                                  </tr>
                                </tfoot>
                              </table>
                            </div>
                    ...
                    <div class="mt-3 text-right">
                      <?php if($source == 'dosen'): ?>
                        <a href="rekapPengujiPklDosen.php" class="btn btn-default btn-lg mr-2"><i class="fas fa-times"></i> Batal</a>
                      <?php else: ?>
                        <a href="daftarPesertaPklAdm.php" class="btn btn-default btn-lg mr-2"><i class="fas fa-times"></i> Batal</a>
                      <?php endif; ?>
    ...
    <script>
      ...
      function calculateAverages() {
          let sumPengLap = 0, countPengLap = 0;
          document.querySelectorAll('input[name^="penguji_laporan_"]').forEach(inp => {
              if (inp.value !== '') { sumPengLap += parseFloat(inp.value); countPengLap++; }
          });
          let avgPengLap = countPengLap > 0 ? (sumPengLap / countPengLap) : 0;
          document.getElementById('avg_peng_lap').innerText = avgPengLap.toFixed(2) + " (" + getGradeLetter(avgPengLap) + ")";

          let sumPengPres = 0, countPengPres = 0;
          document.querySelectorAll('input[name^="penguji_presentasi_"]').forEach(inp => {
              if (inp.value !== '') { sumPengPres += parseFloat(inp.value); countPengPres++; }
          });
          let avgPengPres = countPengPres > 0 ? (sumPengPres / countPengPres) : 0;
          document.getElementById('avg_peng_pres').innerText = avgPengPres.toFixed(2) + " (" + getGradeLetter(avgPengPres) + ")";
      }
      ...
      document.querySelectorAll('input[type="number"]').forEach(inp => {
          ...
          inp.addEventListener('change', function() {
              ...
              fetch('updateNilaiPengujiPklAdm.php', {
                  method: 'POST',
                  body: formData
              }).then(res => {
