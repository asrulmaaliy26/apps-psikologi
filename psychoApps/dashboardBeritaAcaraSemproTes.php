                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <td class="text-center pr-1">
                              <?php
                                ...
                                else if(isset($dnilai['validasi']) && $dnilai['validasi']==1 && $data['penguji3'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji3.php?page=$page&id=$data[id]' role='button' class='btn btn-outline-secondary btn-xs btn-block'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
                                else if(isset($dnilai['validasi']) && $dnilai['validasi']==1 && $data['penguji4'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji4.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
                                else if(isset($dnilai['validasi']) && $dnilai['validasi']==1 && $data['penguji1'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji1.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
                                else if(isset($dnilai['validasi']) && $dnilai['validasi']==1 && $data['penguji2'] == $dtDosen['id']) { echo "<a href='baSemproTesisPenguji2.php?page=$page&id=$data[id]' class='btn btn-outline-secondary btn-block btn-xs' title='Isi atau edit berita acara'><span class='glyphicon glyphicon-list-alt'></span> Isi atau Edit</a>";}
