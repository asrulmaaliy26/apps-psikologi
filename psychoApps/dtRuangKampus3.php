<?php include( "contentsConAdm.php" );
  $qry_jum = "SELECT COUNT(id) AS jumData FROM dt_ruang WHERE lokasi_kampus = 'Kampus 3'";
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                <h4 class="mb-0">Data Ruang Kampus 3</h4>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active small">Data Ruang Kampus 3</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <?php include 'pagination.php';
          ...
          $reload = "dtRuangKampus3.php?pagination=true&keyword=$keyword";
          ...
          WHERE (r.id LIKE '%$keyword%' OR r.nm LIKE '%$keyword%' OR r.kategori LIKE '%$keyword%' OR r.model LIKE '%$keyword%' OR okr.nm LIKE '%$keyword%' OR omr.nm LIKE '%$keyword%') AND r.lokasi_kampus = 'Kampus 3' ORDER BY r.nm ASC";
          
          $result = mysqli_query($con, $sql);
          }else{
          $reload = "dtRuang.php?pagination=true";
          $sql = "SELECT * FROM dt_ruang WHERE lokasi_kampus = 'Kampus 3' ORDER BY nm ASC";
          $result = mysqli_query($con, $sql);
          }
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="dtRuangKampus3.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Kembali" href="dtRuangKampus3.php"><i class="fas fa-sync"></i> Kembali</a>
                      <?php
                        }
                        ?>
                    </div>
              ...
              <section class="col-md-12 connectedSortable">
                <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Data Ruang Kampus 3 (<?php echo $d_jum['jumData']?>)</h4>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="lokasi_kampus" value="Kampus 3">
              </div>
              <div class="form-group">
