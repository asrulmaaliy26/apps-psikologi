                      ...
                      <table class="table table-hover m-0 text-center table-sm custom">
                        ...
                        <tbody>
                                    ...
                                    <div class="card">
                                      ...
                                      <div class="card-body text-left pb-0">
                                        <dl class="row">
                                          ...
                                          <dd class="col-sm-9">
                                              <?php
                                              $fileUrl  = !empty($data['bukti_fisik_file']) ? '../assets/file/skkm/' . $data['bukti_fisik_file'] : '';
                          ...
                          <tr>
                            ...
                            <td colspan="2" class="text-left"><strong><?php if(empty($jumKredit)) { echo "0";} else { echo  $jumKredit;}?> (<?php printf("%1.0f",$persenKredit); print("%");?>)</strong></td>
                          </tr>
                          <tr>
