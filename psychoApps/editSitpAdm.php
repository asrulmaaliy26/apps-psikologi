              ...
              <div class="card card-outline card-success">
                ...
                <div class="card-body">
                  <form action="updateSitpAdm.php" method="post" enctype="multipart/form-data">
                    ...
                    <?php if ($dSurat['tgl_dikeluarkan'] == '0000-00-00') {
                      echo '<input type="text" name="tgl_dikeluarkan" class="sr-only" value="' . date("Y-m-d") . '" readonly required>';
                    } else {
                      echo '<input type="text" name="tgl_dikeluarkan" class="sr-only" value="' . $dSurat['tgl_dikeluarkan'] . '" readonly required>';
                    } ?>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="date" name="tgl_mulai_pkl" class="form-control form-control-sm" value="<?php if ($dSurat['tgl_mulai_pkl'] == '0000-00-00' or empty($dSurat['tgl_mulai_pkl'])) {
                                                                                                                echo "2026-06-22";
                                                                                                              } else {
                                                                                                                echo $dSurat['tgl_mulai_pkl'];
                                                                                                              } ?>" required>
                        </div>
                        <div class="form-group col-md-4">
                          <label>Tanggal Selesai PKL</label>
                          <input type="date" name="tgl_selesai_pkl" class="form-control form-control-sm" value="<?php if ($dSurat['tgl_selesai_pkl'] == '0000-00-00' or empty($dSurat['tgl_selesai_pkl'])) {
                                                                                                                  echo "2026-08-14";
                                                                                                                } else {
                                                                                                                  echo $dSurat['tgl_selesai_pkl'];
                                                                                                                } ?>" required>
                        </div>
                        <div class="form-group">
                          <label>Tembusan Surat</label>
                          <textarea name="tembusan" class="form-control form-control-sm" rows="4" placeholder="Contoh: 1. Wakil Dekan II dan III; 2. Ketua Prodi S1; 3. Kabag TU." required><?php if (empty($dSurat['tembusan'])) {
                                                                                                                                                                                              echo "1. Wakil Dekan II dan III;\n2. Ketua Prodi S1;\n3. Kabag TU.";
                                                                                                                                                                                            } else {
                                                                                                                                                                                              echo $dSurat['tembusan'];
                                                                                                                                                                                            } ?></textarea>
                        </div>
                      </div>
                    </div>
