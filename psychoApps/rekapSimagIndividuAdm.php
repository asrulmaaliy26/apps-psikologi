                      ...
                      <table class="table table-hover table-sm custom mb-0">
                        ...
                        <tbody>
                          ...
                          <tr data-widget="expandable-table" aria-expanded="false">
                            ...
                            <?php if($data['statusform']=='3') { echo '<td class="text-center" width="4%"><a role="button" class="btn btn-block btn-outline-warning btn-xs" onclick="return confirm(\'Status surat telah selesai!\')" title="Status surat telah selesai!" disabled><i class="bi bi-pencil-square"></i></a></td>';} else { echo '<td class="text-center" width="4%"><a href="editSimagIndividuAdm.php?id='.$data['id'].'&page='.$page.'" role="button" class="btn btn-block btn-outline-warning btn-xs" title="Proses surat!"><i class="bi bi-pencil-square"></i></a></td>';}?>
                            ...
                            <td class="text-center p-2">
                              <?php include ("statusMagangIndividuAdm.php");?></td>
                          </tr>
