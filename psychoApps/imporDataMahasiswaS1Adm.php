          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form method="post" action="sformImporDataMahasiswaS1Adm.php" enctype="multipart/form-data">
                  <div class="card card-outline card-success">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Form Impor Profil S1</h4>
                      <a href="images/template-impor-data-mahasiswa-s1.xls" type="button" class="btn btn-outline-success btn-xs float-right" title="Download Template Impor"><i class="fas fa-download"></i> Download Template Profil S1</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="info-box mb-3">
                        <div class="info-box-content">
                          <b>Petunjuk:</b>
                          <ul class="list">
                            <li>Form ini untuk impor data profil akademik <?php echo $dUser['nm'];?> yang belum terdaftar.</li>
                  ...
                  <div class="card-footer clearfix">
                    <button type="submit" class="btn btn-success btn-sm">Mulai Impor Profil</button>
                  </div>
                </div>
              </form>
              </section>
