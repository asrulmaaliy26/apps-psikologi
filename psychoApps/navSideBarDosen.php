  ...
  <div class="sidebar text-xs">
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if ($dtDosen['jabatan_instansi'] == '47') { ?>
          <li class="nav-item <?php echo isOpen(['rekapSaranPembimbingBimtekKaprodi.php', 'rekapKuotaDospemKaprodi.php', 'rekapPembimbinganKaprodi.php', 'allPembPerAngkKaprodi.php']); ?>">
            ...
            <ul class="nav nav-treeview" style="display: block;">
              ...
              <li class="nav-item">
                <a href="rekapPembimbinganKaprodi.php" class="nav-link <?php echo isActive(['rekapPembimbinganKaprodi.php', 'allPembPerAngkKaprodi.php']); ?>">
                  <i class="text-xs far fa-circle nav-icon"></i>
                  <p>Seluruh Pembimbing Mhs</p>
                </a>
              </li>
            </ul>
          </li>
        ...
        if (mysqli_num_rows($q_is_reviewer) > 0 && isFeatureEnabled('bimtek')): ?>
