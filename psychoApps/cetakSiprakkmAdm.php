...
if ($id == 'dummy') {
   // DATA DUMMY UNTUK PREVIEW LAYOUT PRAKTIKUM KELOMPOK
   $dt = [
      'id' => 'dummy',
      'no_agenda_surat' => '107',
      'tgl_dikeluarkan' => date('Y-m-d'),
      'dosen_testee' => 'Dr. H. M. Lutfi Mustafa, M.Ag',
      'matkul_testee' => 'Psikologi Agama',
      'waktu' => date('Y-m-d', strtotime('+3 days')),
      'jam' => '08.00',
               ...
               <td width="88%">
                  ...
                  <table width="100%" style="border-collapse:collapse; padding-left:0;">
                     <tr valign="top">
                        ...
                        <td width="2%" align="center">:</td>
                        <td width="80%"><?php if ($dt['no_agenda_surat'] == '') {
                                             echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
                                          } else {
                                             echo '&nbsp;' . $dt['no_agenda_surat'];
                                          } ?>/<?php echo $dkddekanat1['kd_nmr_srt']; ?>/PP.009/<?php echo "$ambilbln"; ?>/<?php echo "$ambilthn"; ?></td>
