          ...
          <div class="container-fluid">
            <div class="row">
              <section class="col-md-12 connectedSortable">
                <form method="post" action="sformImporUserMahasiswaS2Adm.php" enctype="multipart/form-data">
                  <div class="card card-outline card-info">
                  <div class="card-header">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Form Impor Akun S2</h4>
                      <a href="images/template-impor-data-mahasiswa.xls" type="button" class="btn btn-outline-info btn-xs float-right" title="Download Template Impor"><i class="fas fa-download"></i> Download Template Akun S2</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="info-box mb-3">
                        <div class="info-box-content">
                          ...
                          <ul class="list">
                            ...
                            <li>Pastikan kolom level diisi dengan angka 3 untuk S2.</li>
                          </ul>
                        </div>
                      </div>
                  ...
                  <div class="card-footer clearfix">
                    <button type="submit" class="btn btn-info btn-sm">Mulai Impor Akun S2</button>
                  </div>
                </div>
              </form>
              </section>
