...
<body class="hold-transition <?php echo $isLoggedIn ? 'sidebar-mini layout-fixed' : ''; ?>">
  <div class="wrapper">
    ...
    ?>
      <!-- Beautiful Public Topbar Header -->
      <nav class="navbar navbar-expand navbar-dark" style="background: #1e212d; border-bottom: 1px solid #2f3242; padding: 12px 24px;">
        <a class="navbar-brand font-weight-bold d-flex align-items-center" href="#" style="font-size: 1.15rem; letter-spacing: 0.5px; color: #fff;">
          <img src="../assets/logo psikologi .png" alt="Logo" style="height: 35px;" class="mr-2">
          <span class="ml-2 font-weight-bold">Fakultas Psikologi UIN Malang</span>
        </a>
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a href="../index.php" class="btn btn-outline-primary btn-sm px-3" style="border-radius: 20px; font-weight: 600; transition: all 0.2s;">
    ...
    $isAdminUtama = $isAuthorizedCalendarAdmin;
    ?>
          ...
          <div class="row mb-2 animate__animated animate__fadeIn">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <?php else: ?>
                  <li class="breadcrumb-item small"><a class="text-primary" href="../index.php">Beranda</a></li>
                <?php endif; ?>
            ...
            <div class="col-lg-3 col-md-4 animate__animated animate__fadeInLeft">
              ...
              <div class="card card-calendar mb-4 shadow-sm">
                <div class="card-body p-3">
                  <?php if ($isLoggedIn): ?>
                    <button id="btnAddEvent" class="btn btn-primary btn-block py-2 mb-2" style="border-radius: 8px; font-weight: 600; font-size: 0.9rem;">
                      <i class="fas fa-plus mr-2"></i><?php echo $isAdminUtama ? 'Tambah Kegiatan' : 'Ajukan Kegiatan'; ?>
                    </button>
                  <?php endif; ?>
                  
                  <?php if ($isAuthorizedCalendarAdmin): ?>
                    <a href="rekapKalender.php" class="btn btn-outline-info btn-block py-2 mb-2" style="border-radius: 8px; font-weight: 600; font-size: 0.9rem;">
                      <i class="fas fa-list mr-2"></i> Rekap Kegiatan
                    </a>
                  <?php endif; ?>
    ...
    ?>
      <footer class="main-footer" style="margin-left: 0 !important; background: #161820; border-top: 1px solid #2a2d3a; color: #94a3b8; text-align: center; padding: 15px;">
