<?php
  ...
  $query = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE mag_periode_thesis_camp SET start_datetime='$start_datetime', end_datetime='$end_datetime' WHERE id='$id'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
